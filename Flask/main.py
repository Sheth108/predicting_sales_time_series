...
def render_message():
    ...
    features = ['storeNum', 'itemNum', 'numDays', 'totalInfo',
                'printSummary', 'JSON']
    ...
    messages = ["The store number must be an integer between 1 and 10.",
                ...
                "The value for more info must be true or false.",
                "The value for brief summary must be true or false.",
                "The value for JSON must be true or false.",
                ]
